...
%USER INPUTS
AWS = 'L5';            % Station name
run_start = [2016,01,01];     % Model initiation time
run_end = [2016,12,31];       % Model termination time
...
%===================ERA5 input=====================
run_day = 366;
demname = 'Data\L31dem.tif';
filename = 'Data\lake_depth_L3.xlsx';
sheetname = '2016';
