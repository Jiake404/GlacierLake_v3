...
%USER INPUTS
AWS = 'L5';            % Station name
run_start = [2021,01,01];     % Model initiation time
...
% 
% output
days = data_zhou{2:end,5};
% Projection information
info = geotiffinfo(demname);
for i = 1:length(days)
        lakedepth = squeeze(Lake_depth(:,:,days(i)*24-10));
        % 
        outputFile = ['output\L3',num2str(days(i)),'.tif'];
